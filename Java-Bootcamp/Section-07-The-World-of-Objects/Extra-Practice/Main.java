 ...
 * 
 * @description
 *    This is a simple class that represents a Contact Manager system.
 * 
 * @packages
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (status.equals("continue")) {
            ...
            contactManager.setContact(index, editedContact());
            System.out.println("\n\nUPDATED CONTACTS\n\n");
            displayContacts(contactManager);
     ...
     * @return (Contact[])
     * 
     * Returns a list of all of the contacts.
     */
     ...
     * 
     * Prints out the list of all the contacts.
     */
