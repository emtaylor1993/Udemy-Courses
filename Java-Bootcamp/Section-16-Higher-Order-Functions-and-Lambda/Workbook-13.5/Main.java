 ...
 * 
 * @description
 *    This is a simple class that illustrates Java Lists using high order functions.
 * 
 * @packages
 *    Java Utilties (Arrays, List)
 */
...
public class Main {
    public static void main(String[] args) {
        ...
        books.stream()
            ...
            // When mapping an object. We must create a new one.
            ...
            .forEach(book -> System.out.println(book.getGenre() + "\t" + book.getYear() + "\t$" + book.getPrice() + "\t" + book.getTitle()));
    }
}
